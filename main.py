...
recommendations = {
    "ISTJ": {
        ...
        "image": "https://media.giphy.com/media/3o7TKtyCafFf1xJYgQ/giphy.gif"
    },
    "ISFJ": {
        "food": "🥘 된장찌개",
    ...
    "INFJ": {
        ...
        "image": "https://media.giphy.com/media/jn5YlfHd6PjGU/giphy.gif"
    },
    "INTJ": {
        "food": "🍷 스테이크 & 와인",
        "reason": "전략가형 INTJ는 고급스럽고 효율적인 걸 좋아하죠. 완벽하게 구운 스테이크와 와인으로 멋진 식사를!",
        "personality": "분석적이고 독립적인 사고를 중시하며 목표 지향적인 전략가예요.",
        "image": "https://media.giphy.com/media/1msA64Zp6mRYY/giphy.gif"
    },
    "ISTP": {
        "food": "🍜 일본식 라멘",
    ...
    "ISFP": {
        ...
        "image": "https://media.giphy.com/media/3orieZbU2vQfLbuU3O/giphy.gif"
    },
    "INFP": {
        "food": "🍫 수제 초콜릿",
        "reason": "이상주의자 INFP에게는 감정을 담은 수제 초콜릿! 달콤한 상상력이 피어납니다 🍫✨",
        "personality": "창의적이고 이상을 중시하며 깊은 감정을 지닌 성격이에요. 가치에 따라 행동해요.",
        "image": "https://media.giphy.com/media/3o7TKP9lnsDIYz8Uvu/giphy.gif"
    },
    "INTP": {
        "food": "☕ 아메리카노 & 크로와상",
    ...
    "ENFJ": {
        ...
        "image": "https://media.giphy.com/media/3o6Zt8zb1rXhD1GqqA/giphy.gif"
    },
    "ENTJ": {
        "food": "🥩 프라임 립",
        "reason": "카리스마 넘치는 ENTJ는 고급지고 강렬한 프라임 립이 어울려요. 성공한 리더의 식사 스타일!",
        "personality": "결단력 있고 지도력 있는 성격이에요. 효율성과 성공을 중시해요.",
        "image": "https://media.giphy.com/media/l3vR9O9rGACpTtq4w/giphy.gif"
    }
}

if mbti:
    st.image(recommendations[mbti]['image'], use_column_width=True)
    st.subheader(f"🧠 {mbti}의 성격")
